...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data Pengajar Diklat TT')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Pengajar Diklat TT</a></li>
        <li class="active">Tambah Pengajar TT</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                    ...
                    <h1>Tambah Data Pengajar Diklat TT</h1>
                    <hr/>

                    {!! Form::open(['url' => 'pengajartt', 'class' => 'form-horizontal']) !!}
