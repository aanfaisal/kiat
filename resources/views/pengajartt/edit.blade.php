...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Pengajar Diklat TT')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Pengajar Diklat TT</a></li>
        <li class="active">Edit Pengajar Diklat TT</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                ...
                <h1>Edit Pengajar TT</h1>
                <hr/>

                {!! Form::model($pengajartt, [
                    'method' => 'PATCH',
                    'url' => ['pengajartt', $pengajartt->pengajartt_id],
