...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data TOR Diklat TT')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>TOR Diklat TT</a></li>
        <li class="active">Tambah tor</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                    ...
                    <h1>Tambah Data TOR Diklat TT</h1>
                    <hr/>

                    {!! Form::open(['url' => 'tortt', 'class' => 'form-horizontal']) !!}
