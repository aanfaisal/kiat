...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data Kondisi Ruang')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Kondisi Ruang</a></li>
        <li class="active">Tambah Kondisi Ruang</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                    ...
                    <h1>Tambah Data Kondisi Ruang</h1>
                    <hr/>

                    {!! Form::open(['url' => 'kondisiruang', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('lcd') ? 'has-error' : ''}}">
                {!! Form::label('lcd', 'LCD Projector: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
