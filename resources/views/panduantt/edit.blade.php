...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Panduan Diklat TT')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Panduan Diklat TT</a></li>
        <li class="active">Edit Panduan TT</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                ...
                <h1>Edit Panduan TT</h1>
                <hr/>

                {!! Form::model($panduantt, [
                    'method' => 'PATCH',
                    'url' => ['panduantt', $panduantt->panduantt_id],
