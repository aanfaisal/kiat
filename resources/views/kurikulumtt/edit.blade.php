...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Kurikulum TT')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Kurikulum TT</a></li>
        <li class="active">Edit Kurikulum TT</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                ...
                <h1>Edit Kurikulum TT</h1>
                <hr/>

                {!! Form::model($kurikulumtt, [
                    'method' => 'PATCH',
                    'url' => ['kurikulumtt', $kurikulumtt->kurikulumtt_id],
