...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data Peserta Diklat TT')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Peserta Diklat TT</a></li>
        <li class="active">Tambah Peserta TT</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                    ...
                    <h1>Tambah Data Peserta Diklat TT</h1>
                    <hr/>

                    {!! Form::open(['url' => 'pesertatt', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('tgllahir') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::date('tgllahir', null, ['class' => 'form-control', 'required' => 'required']) !!}
            ...
            <div class="form-group {{ $errors->has('agama') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::text('agama', null, ['class' => 'form-control', 'required' => 'required']) !!}
            ...
            <div class="form-group {{ $errors->has('ruang_id') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::number('ruang_id', null, ['class' => 'form-control']) !!}
