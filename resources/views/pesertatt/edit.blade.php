...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Peserta Diklat TT')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Peserta Diklat TT</a></li>
        <li class="active">Edit Peserta TT</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                ...
                <h1>Edit Peserta Diklat TT</h1>
                <hr/>

                {!! Form::model($pesertatt, [
                    'method' => 'PATCH',
                    'url' => ['pesertatt', $pesertatt->pesertatt_id],
