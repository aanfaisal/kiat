...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Kondisi Kamar')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Kondisi Kamar</a></li>
        <li class="active">Edit Kondisi Kamar</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                ...
                <h1>Edit Kondisi Kamar</h1>
                <hr/>

                {!! Form::model($kondisikm, [
                    'method' => 'PATCH',
                    'url' => ['kondisikm', $kondisikm->kondisikm_id],
