...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Pengajar Diklat TA')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Pengajar Diklat TA</a></li>
        <li class="active">Edit pengajar</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                ...
                {!! Form::model($pengajar, [
                    'method' => 'PATCH',
                    'url' => ['pengajar', $pengajar->pengajar_id],
            ...
            <div class="form-group {{ $errors->has('telp') ? 'has-error' : ''}}">
                {!! Form::label('telp', 'Telp : ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
