...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data Pengajar Diklat TA')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Pengajar Diklat TA</a></li>
        <li class="active">Tambah Pengajar TA</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                    ...
                    <h1>Tambah Data Pengajar Diklat TA</h1>
                    <hr/>
           ...
           <div class="form-group {{ $errors->has('nama') ? 'has-error' : ''}}">
            ...
            <div class="form-group {{ $errors->has('telp') ? 'has-error' : ''}}">
                {!! Form::label('telp', 'No.Telp: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
