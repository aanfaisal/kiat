...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Kurikulum TA')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Kurikulum TA</a></li>
        <li class="active">Edit Kurikulum TA</li>
    </ol>
</section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Kurikulum TA</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
        <hr/>

                <h1>Edit Kurikulum Diklat TA</h1>
                <hr/>

                {!! Form::model($kurikulumtum, [
                    'method' => 'PATCH',
                    'url' => ['kurikulumta', $kurikulumtum->kurikulumta_id],
