...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Edit Data Sertifikat Diklat TT')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Sertifikat Diklat TT</a></li>
        <li class="active">Edit sertifikattt</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                ...
                <h1>Edit Sertifikat TT</h1>
                <hr/>

                {!! Form::model($sertifikattt, [
                    'method' => 'PATCH',
                    'url' => ['sertifikattt', $sertifikattt->sertifikattt_id],
            ...
            <div class="form-group {{ $errors->has('jenistt_id') ? 'has-error' : ''}}">
                {!! Form::label('jenistt_id', 'Nama Jenis: ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
