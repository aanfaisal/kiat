...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data Ruangan Kelas')
...
<section class="content">
        ...
        <hr/>
                    ...
                    <h1>Tambah Data Ruangan Kelas</h1>
                    <hr/>

                    {!! Form::open(['url' => 'ruang', 'class' => 'form-horizontal']) !!}

            <div class="form-group {{ $errors->has('nama') ? 'has-error' : ''}}">
                {!! Form::label('nama', 'Nama Ruang : ', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
