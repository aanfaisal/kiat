...
<section class="content-header">
    <h1>
        @yield('contentheader_title', 'Tambah Data Sertifikat Diklat TA')
        <small>@yield('contentheader_description')</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Sertifikat Diklat TA</a></li>
        <li class="active">Tambah Sertifikat Diklat TA</li>
    </ol>
</section>
...
<section class="content">
        ...
        <hr/>
                    ...
                    <h1>Tambah Data Sertifikat Diklat TA</h1>
                    <hr/>

                    {!! Form::open(['url' => 'sertifikat', 'class' => 'form-horizontal']) !!}
